...
namespace MISA.Meinvoice.Kinesis.Invoice
{
    public class InvoiceRecordProcessor : IShardRecordProcessor
    {
        ...
        private void ProcessRecordsWithRetries(List<Record> records)
        {
            ...
            //            Invoice Invoice = JsonSerializer.Deserialize<Invoice>(recordData);
            //            SyncData(Invoice);
            //            // Uncomment the following if you wish to see the retrieved record data.
            //            //object Invoice = DeserializeFromStream(rec.Data);
            //            //Console.Error.WriteLine(
            //            //    String.Format("Retrieved record:\n\tpartition key = {0},\n\tsequence number = {1},\n\tdata = {2}",
            //            //    rec.PartitionKey, rec.SequenceNumber, JsonSerializer.Serialize(Invoice)));
        ...
        //private void SyncData(Invoice Invoice)
        //{
        ...
        //                dynamicParameters.Add("InvoiceCode", Invoice.Invoice_code);
        //                dynamicParameters.Add("InvoiceAddress", Invoice.address);
        //                dynamicParameters.Add("InvoiceEmail", Invoice.email);
        //                dynamicParameters.Add("BuyerLegalName", Invoice.buyer_legal_name);
        //                dynamicParameters.Add("PhoneNumber", Invoice.phone_number);
        //                dynamicParameters.Add("Priority", Invoice.priority);
        //                dynamicParameters.Add("ActiveScheduleDate", Invoice.active_schedule_date);
        //                dynamicParameters.Add("CurrentScheduleInvoice", Invoice.current_schedule_invoice);
        //                dynamicParameters.Add("NewScheduleInvoice", Invoice.new_schedule_invoice);
        //                dynamicParameters.Add("MessageType", Invoice.message_type);
        //                dynamicParameters.Add("Status", Invoice.status);
        //                dynamicParameters.Add("TaxCode", Invoice.taxcode);
        //                _connection.Execute("Proc_SyncInvoiceData", dynamicParameters, commandType: CommandType.StoredProcedure);
        //            }
        //            catch (Exception ex)
        //            {
    ...
    class MainClass
    {
        ...
        public static void Main(string[] args)
        {
            try
            {
                KclProcess.Create(new InvoiceRecordProcessor()).Run();
            }
            catch (Exception e)
            {
